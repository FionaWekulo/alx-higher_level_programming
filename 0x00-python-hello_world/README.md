																																	        ...
																																	        if (check_cycle(head) == 0)
																																		        ...
																																		        printf("Linked list has no cycle\n");
																																					    ...
																																					    for (i = 0; i < 4; i++)
																																								...
																																								Solving a problem is already a big win! but finding the best and optimal way to solve it, s way better! Think about the most optimal / fastest way to do it.
